        ...
        centreList.append(`<li class="minicourses-list-li col-3" style="height: auto">
                <div class="minicourses-list-li-div">
                    ...
                    <div class="text-center"  style="padding: 15px 0">
                        ...
                        <a class=" btn btn-success" style=" font-size: 16px; color: white; padding: 5px 12px">Rooms</a>&nbsp;<a class=" btn btn-success" style="font-size: 16px; color: white; padding: 5px 12px">Batches</a>&nbsp;
